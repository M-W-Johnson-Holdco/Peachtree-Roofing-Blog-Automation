...
Run:
    python search_all_roofing.py

Output:
    output/sources/search_results_all_roofing.json
...
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / "output" / "sources" / "search_results_all_roofing.json"
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Peachtree Blog Pipeline - search_all_roofing.py")
    print(
