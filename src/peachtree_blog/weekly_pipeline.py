...
from peachtree_blog.paths import GENERATED_DIR, GENERATED_WEEKLY_PIPELINE_PATH, PROJECT_ROOT
...
def monday_failure_slack_text(*, iso_week: str) -> str:
    return (
        ...
        "Metro Atlanta roofing stories. Will retry Wednesday at 8:00 AM ET "
        "with widened search."
    )
...
def no_draft_slack_text(*, iso_week: str) -> str:
    return (
        f"No blog draft for week {iso_week} — search found no qualifying "
        "Metro Atlanta roofing stories after the Wednesday retry. "
