...
from peachtree_blog.slack_actions.processor import process_slack_event, should_process_slack_event
from peachtree_blog.slack_webhook.github_sync import commit_paths, github_sync_enabled, pull_latest
...
def process_slack_event_with_git_sync(event: dict[str, Any]) -> None:
    ...
    if changed and github_sync_enabled():
        from peachtree_blog.paths import GENERATED_DIR, SOURCES_DIR
